...
var AuthEndpoint = class extends ApiEndpoint {
  ...
  async signOut(oldToken) {
    return await this.postRequest("/signOut", oldToken ?? null);
  }
  /**
...
var TokenManager = class extends ApiEndpoint {
  ...
  async getAccessToken(source = "unknown") {
    ...
    if (this.config.cookieAuth) {
      this.accessTokenExpiration = localStorage.getItem("accessTokenExpiration") ?? void 0;
      this.refreshTokenExpiration = localStorage.getItem("refreshTokenExpiration") ?? void 0;
    }
    if ((this.accessToken !== void 0 || this.config.cookieAuth) && this.accessTokenExpiration) {
...
var ChatMessageEndpoint = class extends ApiEndpoint {
   ...
   *
   * */
  async updateMessage(id, contents) {
    return await this.putRequest(id, { contents });
  }
  /**
...
var WebsocketManager = class {
  ...
  async establishConnection() {
    return new HubConnectionBuilder().withAutomaticReconnect({
      nextRetryDelayInMilliseconds: /* @__PURE__ */ __name((retryContext) => {
        if (retryContext.previousRetryCount >= 10) return null;
        return Math.min(500 * Math.pow(2, retryContext.previousRetryCount), 5e3);
...
var SpaceLocationType = /* @__PURE__ */ ((SpaceLocationType2) => {
  SpaceLocationType2[SpaceLocationType2["UNKNOWN"] = 0] = "UNKNOWN";
  SpaceLocationType2[SpaceLocationType2["SYSTEM"] = 1] = "SYSTEM";
  SpaceLocationType2[SpaceLocationType2["PLANET"] = 2] = "PLANET";
  SpaceLocationType2[SpaceLocationType2["MOON"] = 3] = "MOON";
  return SpaceLocationType2;
})(SpaceLocationType || {});
...
var LocationCharacteristic = /* @__PURE__ */ ((LocationCharacteristic2) => {
  LocationCharacteristic2[LocationCharacteristic2["UNKNOWN"] = 0] = "UNKNOWN";
  LocationCharacteristic2[LocationCharacteristic2["HIGH_TEMPERATURE"] = 1] = "HIGH_TEMPERATURE";
  LocationCharacteristic2[LocationCharacteristic2["LOW_TEMPERATURE"] = 2] = "LOW_TEMPERATURE";
  LocationCharacteristic2[LocationCharacteristic2["HOSTILE_ATMOSPHERE"] = 3] = "HOSTILE_ATMOSPHERE";
  return LocationCharacteristic2;
})(LocationCharacteristic || {});

// src/models/Deployment.ts
var ClientType = /* @__PURE__ */ ((ClientType2) => {
  ClientType2[ClientType2["CLIENT_PORTAL"] = 1] = "CLIENT_PORTAL";
  ClientType2[ClientType2["STAFF_PORTAL"] = 2] = "STAFF_PORTAL";
  return ClientType2;
})(ClientType || {});
